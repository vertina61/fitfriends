...
import { BaseUserEntity, UserService } from '../user/index.js';
...
export class DefaultAuthService implements AuthService {
  ...
  public async authenticate(user: BaseUserEntity): Promise<string> {
  ...
  public async verify(dto: LoginUserDto): Promise<BaseUserEntity> {
